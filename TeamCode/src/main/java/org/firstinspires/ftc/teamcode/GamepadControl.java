    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (teleMove.getRobotSetup().baseType() == BaseType.diagonal) {
                teleMove.diagonalBaseGamepadMove(gamepad1.left_stick_y < 0 ? gamepad1.left_stick_x : -gamepad1.left_stick_x, gamepad1.left_stick_y, gamepad1.right_stick_x, telemetry);
            } else {
